...
public class EnemyMoving : MonoBehaviour
{
    ...
    private GameObject currentBullet; //merkt dir die sachen da wo sie entstanden sind.
    ...
    private bool IsNearEdge()
    {
        ...
        if (castPos.gameObject.activeInHierarchy)
        {
            ...
            if(hitInfo.collider == null) //if we are at an edge
            {
                ...
                var isLookingAtHoleLx = currentClipName == "MoorCrawlerEnemyAWatchOutHole";
                var isLookingAtHoleRx = currentClipName == "MoorCrawlerEnemyAWatchOutHoleRx";
    ...
    private bool IsSpawning()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;
        var isSpawning = currentClipName == "MoorCrawlerEnemyASpawn";
    ...
    private bool IsPatrolling()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;
        var isPatrollingToLx = currentClipName == "MoorCrawlerEnemyARunLoop";
        var isPatrollingToRx = currentClipName == "MoorCrawlerEnemyARunLoopReverse";
    ...
    private bool IsTurning()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;
        var isTurning = currentClipName == "MoorCrawlerEnemyATurn";
    ...
    private bool IsDistracted()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;
        var isDistractedFromLx = currentClipName == "DistractedFromLx";
        var isDistractedFromRx = currentClipName == "DistractedFromRx";
    ...
    private bool IsAtHole()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;
        var isAtHoleLx = currentClipName == "MoorCrawlerEnemyAWatchOutHole";
        var isAtHoleRx = currentClipName == "MoorCrawlerEnemyAWatchOutHoleRx";
    ...
    private bool IsLoadingBigShoot()
    {
        ...
        var isLoadingBigShootRx = currentClipName == "LoadShootRx";
        var isLoadingBigShootLx = currentClipName == "LoadShootLx";
    ...
    private bool IsStartingRunAfterSpawn()
    {
        currentClipInfo = anim.GetCurrentAnimatorClipInfo(0);
        currentClipName = currentClipInfo[0].clip.name;

        var isLoadingBigShoot = currentClipName == "BehemothRunStart";
