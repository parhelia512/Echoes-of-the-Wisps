...
public class MovingPlatformWithStopAndBlockAtLastCp : MonoBehaviour
{
    ...
    private bool lastCpReached = false;
    ...
    void Update()
    {
        if (playerDetector.PlayerDetected && !isActive && !lastCpReached)
        {
